...
// --- ESTRUCTURA DE NIVELES (MODIFICADA) ---
const levels = [
    {
        ...
        boxes: [ 
            { 
                ...
                content: [
                    {
                        type: 'image',
                        value: '1b.jpg' // CAMBIA ESTO por tu imagen
                    },
                    { 
                        type: 'text', 
                    ...
                    {
                        type: 'image',
                        value: '1c.jpg' // CAMBIA ESTO por otra imagen
                    },
                    {
                        type: 'text',
        ...
        boxes: [
            { 
                ...
                content: [
                    {
                        type: 'image',
                        value: '2a.jpg' // CAMBIA ESTO por tu imagen
                    },
                    { 
                        type: 'text', 
                    ...
                    {
                        type: 'text',
                        value: 'Los shows musicales atrajeron a una multitud al centro del predio. La mayoría de los espectadores eran jóvenes de ropa urbana que cantaban las canciones de principio a fin, haciendo movimientos rítmicos y constantes con la cabeza. Un poco más atrás, y en menor cantidad, se veían algunos cosplayers que miraban el escenario sonriendo y moviéndose sutilmente al ritmo de la música.' // CAMBIA ESTO por otra imagen
                    },
                    {
                        type: 'image',
                        value: '2b.jpg' // CAMBIA ESTO por tu imagen
                    },
                    {
                        type: 'text',
...
// 7. MOSTRAR Y OCULTAR MENSAJE (¡FUNCIÓN REESCRITA!)
